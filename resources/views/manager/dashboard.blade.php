...
<div class="content p-4">
    <h2 class="mb-4 border-bottom pb-3 text-uppercase">Tableau de bord</h2>
    <div class="card mb-4">
        <div class="card-body">
            <div class="row mb-4">
                <div class="col-md-4">
                    <div class="d-flex border">
                        ...
                        <div class="flex-grow-1 bg-white p-4">
                            <p class="text-uppercase text-secondary mb-0">Total du Personnel</p>
                ...
                <div class="col-md-4">
                    <div class="d-flex border">
                        ...
                        <div class="flex-grow-1 bg-white p-4">
                            <p class="text-uppercase text-secondary mb-0">Colis traités</p>
                            <h3 class="font-weight-bold mb-0">{{ $totalCourierInfo }}</h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="d-flex border">
                        ...
                        <div class="flex-grow-1 bg-white p-4">
                            <p class="text-uppercase text-secondary mb-0">Total Colis à venir</p>
    ...
    <div class="card mb-4">
        <div class="card-header font-weight-bold">
            ...
            STATISTIQUES DES REVENUS MENSUELS
        </div>
