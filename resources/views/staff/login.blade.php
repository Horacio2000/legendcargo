...
<html lang="fr">
    <head>
        ...
        <title>Panel du personnel de la succursale</title>
    </head>
    <body class="bg-info">
            ...
            <div class="row h-100 justify-content-center align-items-center">
                <div class="col-md-5">
                    ...
                    <div class="card border border-success">
                        <div class="card-header  text-white text-uppercase h4 text-center" style="background: #173C5A;">Connexion | Personnel</div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('staff.authenticate') }}">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" placeholder="Email" value="staff@legendecargo.com">
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="hidden" name="role" value="Staff" class="form-control" >
                                </div>
                                <div class="row">
                                    <div class="col pr-2">
                                ...
                                <div class="row">
                                    <a class="btn btn-link" href="{{ route('staff.password.request.form') }}" style="font-size:16px; color: #173C5A; font-weight: 600;">
                                        Mot de passe oublié ?
                                    </a>
                                </div>
                            </form>
