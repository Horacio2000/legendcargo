...
<html lang="fr">
    ...
    <body class="bg-light" id="test">
        <nav class="navbar navbar-expand navbar-dark bg-custom-background">
            ...
            <a class="navbar-brand" href="#">Panneau du Personnel</a>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd_user">
                            <a href="{{ route('staff.profile') }}" class="dropdown-item"><i class="fa fa-user"></i> Profil</a>
                            <a href="{{ route('staff.changepassword') }}" class="dropdown-item"><i class="fa fa-cog"></i> Modifier le mot de passe</a>
