...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">Envoyer des notifications
    </h2>
    <div class="card mb-4">
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="form-group">
                            <input type="text" class="form-control form-control-lg search" id='search' name="search" placeholder="Code-barres/Téléphone">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <table id="table" class="table table-hover table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th>Téléphone de l'expéditeur</th>
                        <th>Succursale bénéficiaire</th>
                ...
                <tbody id="courierAdd">
                <td colspan="10" class="text-center no-info">Aucune Information</td>
                </tbody>
            </table>
            <button type="button" class="btn btn-primary btn-md delete_button float-right" id="sendnotification" style="display:none;" data-toggle="modal" data-target="#receive">
                <i class="fa fa-check"></i> Envoyer une notification
            </button>
                    ...
                    <div class="modal-content">
                        <form method="POST" action="{{ route('send.notification.courier') }}">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="receive"><i class="fa fa-download"></i>&nbsp;Envoyer une notification</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body" id="code">
                                <p><strong>Êtes-vous sûr de leur envoyer des notifications par e-mail et par téléphone ?</strong></p>
                            </div>
    ...
    function searhCourier() {
        ...
        if (code !== '') {
            ...
            $(".invoice_unique").each(function () {
                if ($(this).text() == code) {
                    flag++;
                    toastr.error("Déjà sélectionné ce colis");
                }
            });
            if (flag == 0) {
                $.ajaxSetup({
