...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">{{ Auth::user()->name }} Liste d'encaissement</h2>
    <div class="card mb-4">
        <div class="card-body">
            <div class="row">
                <div class="col-md-8 col-sm-6 col-xs-12">
                    <form method="GET" action="{{ route('staff.cashe.collection') }}" class="form-inline">
                        ...
                        <button type="submit" class="btn btn-primary"><i class="fa fa-search"></i>Voir colis</button>
                    </form>
                </div>
            </div>
