    ...
    <div class="card">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="left">{{ $courierProductInfo->courier_types->name ?? 'N/A' }}</td>
                                    <td class="right">{{ $courierProductInfo->created_at->toDateTimeString() }}</td>
                                    <td class="right">{{ $courierProductInfo->courier_quantity }}&nbsp;{{ $courierProductInfo->courier_types->unit->name ?? 'n/a'}} </td>
        ...
        <div class="row mb-2 ml-2">
            <div class="container">
                ...
                <a href="{{ route('staff.courier.slip',$courierInfo->id) }}" target="_blank"><button class="btn btn-primary"><i class="fa fa-print"></i> Imprimer le reçu</button></a>
                @if($courierInfo->payment_status == 'Non payé')
