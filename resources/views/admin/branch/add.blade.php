...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">Créer un nouveau entrepôt
            ...
            <form action="{{ route('branch.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-12  container-fluid">
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-lg mb-3" type="text" name="name"  value="{{ old('name') }}" placeholder="Nom de l'entrepôt">
                    </div>
                </div>
                <div class="col-md-12 container-fluid">
                    <div class="form-group">
                ...
                <div class="col-md-12 container-fluid">
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-lg mb-3" type="email" name="email"  value="{{ old('email') }}" placeholder="Email de l'entrepôt">
                    </div>
                </div>
                <div class="col-md-12 container-fluid">
                    <div class="form-group">
                        <label for="phone" style="text-transform: uppercase;"><strong>Téléphone</strong></label>
                        <input class="form-control form-control-lg mb-3" type="text" name="phone"  value="{{ old('phone') }}" placeholder="Téléphone de l'entrepôt">
                    </div>
                </div>
                <div class="col-md-12 container-fluid">
                    <div class="form-group">
                        <label for="address" style="text-transform: uppercase;"><strong>Adresse</strong></label>
                        <textarea class="form-control" rows="3" name="address" placeholder="Adresse de l'entrepôt">{{ old('address') }}</textarea>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <br>
                <div class="col-md-12">
                    <button type="submit" class="btn btn-primary btn-block btn-lg">Créer un nouveau entrepôt</button>
                </div>
            </form>
        </div>
    </div>
