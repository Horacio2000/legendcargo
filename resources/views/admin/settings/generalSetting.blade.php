...
<div class="content p-4">
    <h2 class="mb-4" style="text-transform: uppercase;">Réglage de base</h2>
    <div class="card mb-4">
        <div class="card-body">
            <form action="{{ route('admin.basicSettingUpdate',$settings->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row container-fluid">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="title" style="text-transform: uppercase;"><strong>Titre du site</strong></label>
                            <input class="form-control form-control-lg mb-3" name="title" value="{{ $settings->title ?? old('title') }}"  type="text">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="website_title" style="text-transform: uppercase;"><strong>Code couleur de base du site</strong></label>
                ...
                <div class="row  container-fluid">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="base_currency" style="text-transform: uppercase;"><strong>Texte de la devise de base</strong></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="website_title" style="text-transform: uppercase;"><strong>Symbole de la devise de référence</strong></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="email_verification" style="text-transform: uppercase;"><strong> NOTIFICATION PAR EMAIL</strong></label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="sms_verification" style="text-transform: uppercase;"><strong>NOTIFICATION PAR SMS </strong></label>
