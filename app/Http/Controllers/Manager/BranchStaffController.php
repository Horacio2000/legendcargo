...
class BranchStaffController extends Controller {
    ...
    public function index(Request $request) {
        ...
        if (!empty($searchtext)) {
            $branchStaffList = User::where([['role', 'Staff'], ['branch_id', Auth::user()->branch_id]])
            ...
            $branchStaffList = User::where([['role', 'Staff'], ['branch_id', Auth::user()->branch_id]])->paginate(20);
        }
    ...
    public function store(Request $request, User $staff) {
        ...
        return back()->withSuccess('Le personnel a été créé avec succès');
    }
    ...
    public function update(Request $request, User $branchstaff) {
        ...
        return back()->withSuccess('Le personnel a été mis à jour avec succès');
    }
    ...
    public function changePassword(Request $request) {
        $niceName = [
            ...
            'newword_confirmation' => 'Confirmez le mot de passe',
        ];
        $rules = [
