if ($.isFunction($.fn.dataTable)) {
    $.extend(true, $.fn.dataTable.defaults, {
        ...
        initComplete: function (settings, json) {
            ...
            var search_button = $('<button type="button" class="btn btn-link btn-sm btn-icon ml-2 mb-1" data-toggle="tooltip" title="Rechercher"><i class="fa fa-fw fa-search"></i></button>')
                .click(function () {
